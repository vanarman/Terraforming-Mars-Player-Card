...
const ActionPhaseModal = () => {
  ...
  return (
    <Actionsheet isOpen={modal["actionModalVisibility"]} onClose={() => dispatch(hide({ modalType: "actionModalVisibility"}))} zIndex={999}>
      <ActionsheetBackdrop />
      <ActionsheetContent zIndex={999}>
        ...
        <ActionsheetItem onPress={() => {
          ...
          <ActionsheetItemText>{t('action.standardProject')}</ActionsheetItemText>
        </ActionsheetItem>
        <ActionsheetItem onPress={() => {
          dispatch(show({ modalType: "milestoneModalVisibility"}));
          dispatch(hide({ modalType: "actionModalVisibility"}));
        }}>
          <ActionsheetItemText>{t('action.claimMilestone')}</ActionsheetItemText>
        </ActionsheetItem>
        <ActionsheetItem onPress={() => {
        ...
        >
          <ActionsheetItemText>{t('action.blueCardAction')}</ActionsheetItemText>
        </ActionsheetItem>
        <ActionsheetItem 
        ...
        >
          <ActionsheetItemText>{t('action.increaseTemperature')}</ActionsheetItemText>
        </ActionsheetItem>
      </ActionsheetContent>
    </Actionsheet>
  );
